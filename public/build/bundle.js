    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 25, 2, 388);
    			attr_dev(header, "class", "svelte-m17zzh");
    			add_location(header, file$5, 24, 0, 376);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 89, 4, 1617);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 87, 4, 1579);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 70, 4, 985);
    			attr_dev(h2, "class", "svelte-94tihd");
    			add_location(h2, file$3, 71, 4, 1006);
    			attr_dev(p0, "class", "svelte-94tihd");
    			add_location(p0, file$3, 72, 4, 1030);
    			attr_dev(header, "class", "svelte-94tihd");
    			add_location(header, file$3, 69, 2, 972);
    			...
    			add_location(img, file$3, 75, 4, 1085);
    			attr_dev(div0, "class", "image svelte-94tihd");
    			add_location(div0, file$3, 74, 2, 1061);
    			attr_dev(p1, "class", "svelte-94tihd");
    			add_location(p1, file$3, 78, 4, 1159);
    			attr_dev(div1, "class", "content svelte-94tihd");
    			add_location(div1, file$3, 77, 2, 1133);
    			attr_dev(footer, "class", "svelte-94tihd");
    			add_location(footer, file$3, 80, 2, 1192);
    			attr_dev(article, "class", "svelte-94tihd");
    			add_location(article, file$3, 68, 0, 960);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$2, 22, 0, 374);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 47, 8, 923);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 82, 2, 2495);
    			attr_dev(main, "class", "svelte-14fgpj0");
    			add_location(main, file, 81, 0, 2486);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
