...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header, file$2, 24, 0, 376);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 64, 4, 879);
    			attr_dev(h2, "class", "svelte-8tjse");
    			add_location(h2, file$1, 65, 4, 900);
    			...
    			add_location(img, file$1, 68, 4, 958);
    			attr_dev(div0, "class", "image svelte-8tjse");
    			add_location(div0, file$1, 67, 2, 934);
    			attr_dev(p, "class", "svelte-8tjse");
    			add_location(p, file$1, 71, 4, 1034);
    			attr_dev(div1, "class", "content svelte-8tjse");
    			add_location(div1, file$1, 70, 2, 1008);
    			add_location(button0, file$1, 74, 4, 1080);
    			add_location(button1, file$1, 75, 4, 1114);
    			attr_dev(footer, "class", "svelte-8tjse");
    			add_location(footer, file$1, 73, 2, 1067);
    			attr_dev(article, "class", "svelte-8tjse");
    			add_location(article, file$1, 62, 0, 854);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:2) {#each meetups as meetup}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file, 52, 0, 1512);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
